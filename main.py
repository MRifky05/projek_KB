...
dataset_path = "C:\\Users\\riamu\\Documents\\Praktikum Sem3\\kb\\validator"
...
if len(X) <= test_size:
    raise ValueError("Dataset size is too small to allocate test samples. Please provide more data.")
...
image_to_test = ["validator/rifky/rifky.jpg", "validator/angel/angel.jpg"]
